      ...
      <section id="entregas" className="delivery">
        ...
        <div className="delivery-grid reveal">
          ...
          <div className="delivery-item">
            <div className="delivery-card" onClick={handleToggleDescription}>
          ...
          <div className="delivery-item">
            ...
            <div className="delivery-description">
              <p>O módulo de análise metabólica será responsável pelo processamento automatizado dos dados corporais do usuário, realizando cálculos de indicadores importantes, como Índice de Massa Corporal (IMC), Taxa Metabólica Basal (TMB) e Necessidade Diária de Calorias (NDC).</p>
              <p>Com base nesses resultados, o sistema fornecerá uma análise inicial do condicionamento físico e das necessidades energéticas do praticante, auxiliando na interpretação dos dados corporais e oferecendo suporte para a definição de estratégias relacionadas ao treino e à alimentação.</p>
              <p>Além disso, essa funcionalidade substituirá processos manuais por uma solução digital mais organizada, prática e eficiente.</p>
            </div>
          </div>
          ...
          <div className="delivery-item">
            ...
            <div className="delivery-description">
              <p>O sistema também possuirá um módulo de acompanhamento corporal, desenvolvido para armazenar e organizar o histórico físico dos usuários ao longo do tempo.</p>
              <p>A plataforma registrará informações como peso, medidas corporais e indicadores metabólicos, permitindo que o usuário acompanhe sua evolução física de maneira prática e intuitiva. Dessa forma, será possível visualizar resultados, comparar desempenhos e manter um controle contínuo da evolução corporal.</p>
              <p>Esse acompanhamento contribuirá para maior motivação, organização e monitoramento do progresso dos praticantes dentro da academia.</p>
            </div>
          </div>
        </div>
      </section>
